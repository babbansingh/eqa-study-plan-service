...
* The original package name 'com.eqa.eqa-study-plan-service' is invalid and this project uses 'com.eqa.eqastudyplanservice' instead.
...
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/3.1.9-SNAPSHOT/reference/htmlsingle/index.html#actuator)
